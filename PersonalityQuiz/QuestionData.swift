...
enum emperorType : Character {
  case basil = "⚔️"
    ...
    var emperorDescription: String {
        switch self {
        case .basil:
            return "You're Basil the 2nd! You are practial and efficient, perhaps to the extreme. When you set your mind to a task you will complete it, no matter what it takes or what gets in the way. While your choices may be controversial at home and abroad, you don't let this stop from making major changes in the world"
        case .justinian:
